    ...
    return (
        <>
            ...
            <View style={styles.statusRow}>
                ...
                <View style={[styles.statusBadge, isTripEnded ? styles.endedBadge : isFull ? styles.fullBadge : styles.activeBadge]}>
                    <View style={[styles.statusDot, {backgroundColor: isTripEnded ? "#777" : isFull ? "#E74C3C" : "#4CAF50"}]}/>
                    <Text style={[styles.statusText, {color: isTripEnded ? "#777" : isFull ? "#E74C3C" : "#4CAF50"}]}>
                        {isTripEnded ? "ENDED" : isFull ? "FULL" : "AVAILABLE"}
                    </Text>
                </View>
            </View>
