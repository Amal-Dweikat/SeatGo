...
export default function CardInfoDriver(){
     ...
     <Image
      source={ require("../assets/images/Driver3.jpg")} style={styles.driverImage} />
       <View style={styles.DriverInfo} >
         <Text style={styles.driverName} >{" Liam Brown"}</Text>
         <Text ><Ionicons name="person" size={16} color="#E55C16" />{" : Liam Maren Tera Brown"}</Text>
         <Text ><Ionicons name="call" size={16} color="#E55C16" />{" : 056-969-1309"}</Text>
         <Rating rating={3.5} />
       </View>
    </View  >
